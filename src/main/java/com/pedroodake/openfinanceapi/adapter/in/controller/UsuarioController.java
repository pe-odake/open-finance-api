...
public class UsuarioController implements
        ListagemController<DadosListagemUsuario>,
        AtualizacaoController<DadosAtualizacaoUsuario, DadosDetalhamentoUsuario>,
        ExclusaoController<Void, Long>,
        DetalhamentoController<DadosDetalhamentoUsuario, Long> {
